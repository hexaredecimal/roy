...
var grammar = {
  ...
  "bnf": {
    ...
    "callArgument": [
      ...
      ["accessor", "$$ = $1;"],
      ["callArgument @ innerExpression", n("$$ = new yy.Call(new yy.Identifier($2), [$1, $3]);")],
      ["callArgument MATH innerExpression", n("$$ = new yy.Call(new yy.Identifier($2), [$1, $3]);")],
      ["callArgument CONCAT innerExpression", n("$$ = new yy.Call(new yy.Identifier($2), [$1, $3]);")],
      ["callArgument + innerExpression", n("$$ = new yy.Call(new yy.Identifier($2), [$1, $3]);")],
      ["callArgument - innerExpression", n("$$ = new yy.Call(new yy.Identifier($2), [$1, $3]);")],
