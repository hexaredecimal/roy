...
var grammar = {
  ...
  "bnf": {
    ...
    "callArgument": [
      ...
      ["accessor", "$$ = $1;"],
      ["callArgument @ expression", n("$$ = new yy.Call(new yy.Identifier($2), [$1, $3]);")],
      ["callArgument MATH expression", n("$$ = new yy.Call(new yy.Identifier($2), [$1, $3]);")],
      ["callArgument CONCAT expression", n("$$ = new yy.Call(new yy.Identifier($2), [$1, $3]);")],
      ["callArgument + expression", n("$$ = new yy.Call(new yy.Identifier($2), [$1, $3]);")],
      ["callArgument - expression", n("$$ = new yy.Call(new yy.Identifier($2), [$1, $3]);")],
      ["callArgument BOOLOP expression", n("$$ = new yy.Call(new yy.Identifier($2), [$1, $3]);")],
      ["callArgument COMPARE expression", n("$$ = new yy.Call(new yy.Identifier($2), [$1, $3]);")],
      ["callArgument WITH expression", n("$$ = new yy.With($1, $3);")],
      ["callArgument OPERATOR expression", n("$$ = new yy.Call(new yy.Identifier($2), [$1, $3]);")],
